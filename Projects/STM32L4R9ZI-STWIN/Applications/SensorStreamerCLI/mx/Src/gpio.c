...
void MX_GPIO_PE8_Init(void)
{
  ...
  HAL_NVIC_EnableIRQ(EXTI9_5_IRQn); //TODO: STF - I want to listen the IRQ only after the initialization when the user tasks run
}
...
void MX_GPIO_PE14_Init(void)
{
  ...
  HAL_NVIC_SetPriority(INT1_ADWB_EXTI_IRQn, 5, 0);
  HAL_NVIC_EnableIRQ(INT1_ADWB_EXTI_IRQn); //TODO: STF - I want to listen the IRQ only after the initialization when the user tasks run
...
void MX_GPIO_PF4_Init(void)
{
  ...
  HAL_NVIC_EnableIRQ(EXTI4_IRQn); //TODO: STF - I want to listen the IRQ only after the initialization when the user tasks run
}
