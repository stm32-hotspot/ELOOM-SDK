...
sys_error_code_t SysLoadApplicationContext(ApplicationContext *pAppContext)
{
  ...
  spISM330DHCXObj = ISM330DHCXTaskAlloc(&MX_GPIO_PE4InitParams, NULL, &MX_GPIO_PA4InitParams);
  spIIS3DWBObj = IIS3DWBTaskAlloc(&MX_GPIO_PE3InitParams, &MX_GPIO_PA15InitParams);
  spUtilObj = SCLIUtilTaskAlloc(&MX_GPIO_PD2InitParams, NULL);
