...
/* USER CODE BEGIN 0 */
#define STBC02_USED_TIM_CLKFreq               (HAL_RCC_GetPCLK2Freq() * (((READ_BIT(RCC->CFGR, RCC_CFGR_PPRE2) >> RCC_CFGR_PPRE2_Pos) < 4U) ? 1U : 2U))
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM16_MspDeInit 0 */
    ...
    PE0     ------> TIM16_CH1
    */
    HAL_GPIO_DeInit(STBC02_CHG_PIN_GPIO_Port, STBC02_CHG_PIN_Pin);
